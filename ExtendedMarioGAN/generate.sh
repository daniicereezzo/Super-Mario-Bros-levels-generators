...
# Train the GAN
#python -u train.py --seed $seed --version 1 --cuda
#python -u train.py --seed $seed --version 2 --cuda

# Generate the levels with GAN
python -u generate_random.py --seed $seed --version 1
python -u generate_random.py --seed $seed --version 2

# Generate the levels with MarioGAN
python -u generate_cma.py --seed $seed --version 1
python -u generate_cma.py --seed $seed --version 2