...
def convert_level_to_vglc(level_lines):
    vglc_lines = []
    for line in level_lines:
        vglc_line = ""
        for char in line:
            vglc_line += convert_char_to_vglc(char)
        vglc_lines.append(vglc_line)
    
    return vglc_lines

def convert_char_to_vglc(char):
    if char == "M" or char == "F":
        print("ERROR. Level contains initial or final positions.")
        sys.exit(1)
    
    if char == "#":
        return "X"
    elif char == "C" or char == "L" or char == "U" or char == "2" or char == "1" or char == "D" or char == "%":
        return "S"
    elif char == "@" or char == "!":
        ...
        return "-"
    elif char == "g" or char == "G" or char == "r" or char == "R" or char == "k" or char == "K" or char == "y" or char == "Y":
        return "E"
    else:
        return char
